...
def control(ctx: click.Context, table: str, files: Iterable[str], ignore: str, parser: str = "alto"):
    control_table = Translator.parse(table, normalization=_get_unorm(ctx))
...
def convert(
    ...
    for file in tqdm.tqdm(files):
        ...
        instance: Parser = convert_file(file, control_table, normalization=_get_unorm(ctx), parser=parser)
